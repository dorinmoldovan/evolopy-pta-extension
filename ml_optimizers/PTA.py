...
def PTA(objf, lb, ub, dim, PopSize, iters, Pred, y_test_standardized):
    ...
    for i in range(0, PopSize):
        flowerScore[i] = objf(flowers[i, :], ub, Pred, y_test_standardized)
        plumScore[i] = objf(plums[i, :], ub, Pred, y_test_standardized)
